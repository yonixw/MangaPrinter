...
namespace MangaPrinter.Conf
{
    ...
    public class SettingItem<T> : SettingBase
    {
        ...
        public SettingItem(T _value, string _info = "")
        {
            value = _value;
            info = _info;
        }
    ...
    public class SettingFile
    {
        ...
        public void addOrUpdateSetting<T>(string cat, string subcat, string name, T value, string info = "")
        {
            SettingBase item = new SettingItem<T>(value,info);
